 ...
 * {@link jsr166e.locks} and
 * {@link jsr166e.atomic} packages.
 *
 * <h2>Executors</h2>
 *
 * <b>Interfaces.</b>
 *
 * {@link jsr166e.Executor} is a simple standardized
 * interface for defining custom thread-like subsystems, including
 * thread pools, asynchronous I/O, and lightweight task frameworks.
 * Depending on which concrete Executor class is being used, tasks may
 * execute in a newly created thread, an existing task-execution thread,
 * or the thread calling {@link jsr166e.Executor#execute
 * execute}, and may execute sequentially or concurrently.
 *
 * {@link jsr166e.ExecutorService} provides a more
 * complete asynchronous task execution framework.  An
 * ExecutorService manages queuing and scheduling of tasks,
 * and allows controlled shutdown.
 *
 * The {@link jsr166e.ScheduledExecutorService}
 ...
 * function expressed as {@link jsr166e.Callable},
 * the result-bearing analog of {@link java.lang.Runnable}.
 *
 * A {@link jsr166e.Future} returns the results of
 * a function, allows determination of whether execution has
 * completed, and provides a means to cancel execution.
 *
 * A {@link jsr166e.RunnableFuture} is a {@code Future}
 ...
 * <b>Implementations.</b>
 *
 * Classes {@link jsr166e.ThreadPoolExecutor} and
 * {@link jsr166e.ScheduledThreadPoolExecutor}
 * provide tunable, flexible thread pools.
 *
 * The {@link jsr166e.Executors} class provides
 * factory methods for the most common kinds and configurations
 * of Executors, as well as a few utility methods for using
 * them.  Other utilities based on {@code Executors} include the
 * concrete class {@link jsr166e.FutureTask}
 * providing a common extensible implementation of Futures, and
 * {@link jsr166e.ExecutorCompletionService}, that
 * assists in coordinating the processing of groups of
 * asynchronous tasks.
 *
 * <p>Class {@link jsr166e.ForkJoinPool} provides an
 * Executor primarily designed for processing instances of {@link
 * jsr166e.ForkJoinTask} and its subclasses.  These
 ...
 * <h2>Queues</h2>
 *
 * The {@link jsr166e.ConcurrentLinkedQueue} class
 * supplies an efficient scalable thread-safe non-blocking FIFO queue.
 * The {@link jsr166e.ConcurrentLinkedDeque} class is
 * similar, but additionally supports the {@link java.util.Deque}
 * interface.
 *
 * <p>Five implementations in {@code jsr166e} support
 * the extended {@link jsr166e.BlockingQueue}
 * interface, that defines blocking versions of put and take:
 * {@link jsr166e.LinkedBlockingQueue},
 * {@link jsr166e.ArrayBlockingQueue},
 * {@link jsr166e.SynchronousQueue},
 * {@link jsr166e.PriorityBlockingQueue}, and
 * {@link jsr166e.DelayQueue}.
 * The different classes cover the most common usage contexts
 * for producer-consumer, messaging, parallel tasking, and
 * related concurrent designs.
 *
 * <p>Extended interface {@link jsr166e.TransferQueue},
 * and implementation {@link jsr166e.LinkedTransferQueue}
 * introduce a synchronous {@code transfer} method (along with related
 * features) in which a producer may optionally block awaiting its
 * consumer.
 *
 * <p>The {@link jsr166e.BlockingDeque} interface
 * extends {@code BlockingQueue} to support both FIFO and LIFO
 * (stack-based) operations.
 * Class {@link jsr166e.LinkedBlockingDeque}
 * provides an implementation.
 *
 * <h2>Timing</h2>
 *
 * The {@link jsr166e.TimeUnit} class provides
 ...
 * <ul>
 *
 * <li>{@link jsr166e.Semaphore} is a classic concurrency tool.
 *
 * <li>{@link jsr166e.CountDownLatch} is a very simple yet
 * very common utility for blocking until a given number of signals,
 * events, or conditions hold.
 *
 * <li>A {@link jsr166e.CyclicBarrier} is a resettable
 * multiway synchronization point useful in some styles of parallel
 * programming.
 *
 * <li>A {@link jsr166e.Phaser} provides
 * a more flexible form of barrier that may be used to control phased
 * computation among multiple threads.
 *
 * <li>An {@link jsr166e.Exchanger} allows two threads to
 ...
 * {@link jsr166e.ConcurrentHashMap},
 * {@link jsr166e.ConcurrentSkipListMap},
 * {@link jsr166e.ConcurrentSkipListSet},
 * {@link jsr166e.CopyOnWriteArrayList}, and
 * {@link jsr166e.CopyOnWriteArraySet}.
 ...
 * jsr166e.ConcurrentHashMap} is "concurrent".  A
 ...
 * <li>they will never throw {@link jsr166eModificationException
 ...
 *
 *
 * The methods of all classes in {@code jsr166e} and its
